...
\frame
{
    ...
    \begin{itemize}
        \item Search controller has 1.4 million observations, while Project and My\_Panjiva have less than 100 thousand
        \item Maybe users respond differently to changes on popular vs. not-popular pages
        \item Must control for previous popularity
    \end{itemize}
}
