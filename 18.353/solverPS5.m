...
for i = 1:length(xInitial)
    for j = 1:length(yInitial)
        ...
        [T,Y] = ode45(@systemPS6,[0:.1:10],[xInitial(i), yInitial(j)]); % This is the solving command line.  
...
xlabel('$$v$$','FontSize',16,'interpreter','latex')
ylabel('$$\theta$$','FontSize',16,'interpreter','latex')
title('$$D = 2 $$','FontSize',16,'interpreter','latex')
set(gca,'FontSize',14)
